...
url = 'https://www.dlsite.com/maniax/ranking/day' #DLsiteのランキングページのURLを指定する
browser.get(url) #指定したURLのページを開く
elem_login_btn_top = browser.find_element_by_class_name('btn_yes.btn-approval') #ログインボタンの要素を指定する
